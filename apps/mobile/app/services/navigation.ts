...
function navigate<T extends RouteName>(screen: T, params?: RouteParams[T]) {
  if (screen === "Auth" || screen === "Login" || screen === "Signup" || screen === "Welcome" || screen === "PayWall") {
    console.log(`Navigation to ${screen} blocked in Libre Notes`);
    return;
  }
...
function push<T extends RouteName>(screen: T, params: RouteParams[T]) {
  if (screen === "Auth" || screen === "Login" || screen === "Signup" || screen === "Welcome" || screen === "PayWall") {
    console.log(`Push to ${screen} blocked in Libre Notes`);
    return;
  }
...
function replace<T extends RouteName>(screen: T, params: RouteParams[T]) {
  if (screen === "Auth" || screen === "Login" || screen === "Signup" || screen === "Welcome" || screen === "PayWall") {
    console.log(`Replace to ${screen} blocked in Libre Notes`);
    return;
  }
