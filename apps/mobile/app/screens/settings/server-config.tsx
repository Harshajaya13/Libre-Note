...
export function ServersConfiguration() {
  ...
  return (
    ...
    >
      <Notice
        text="Local Wi-Fi Network Access: To access your notes from a laptop or phone web browser on the same Wi-Fi network, start the local web app ('npm run dev') on your laptop and connect to your local IP address."
        type="information"
      />
