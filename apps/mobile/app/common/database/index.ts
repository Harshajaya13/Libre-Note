...
export async function setupDatabase(password?: string) {
  ...
  database.host({
    API_HOST: `${localHost}:5264`,
    AUTH_HOST: `${localHost}:8264`,
    SSE_HOST: `${localHost}:7264`,
    SUBSCRIPTIONS_HOST: `${localHost}:9264`,
    ISSUES_HOST: `${localHost}:2624`,
    MONOGRAPH_HOST: `${localHost}:6264`,
    NOTESNOOK_HOST: `${localHost}:8788`,
